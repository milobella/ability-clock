...
RUN git config --global url."https://oauth2:${GITLAB_TOKEN}@github.com".insteadOf "https://github.com"

# Build the ability
RUN go build -o /bin/main cmd/ability/main.go

# Remove milobella token
RUN git config --global --remove-section url."https://oauth2:${GITLAB_TOKEN}@github.com"
